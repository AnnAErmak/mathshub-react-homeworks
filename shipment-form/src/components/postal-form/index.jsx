...
function PostalForm() {
    ...
    return (<form onSubmit={formik.handleSubmit} className="postal-form">
        ...
        <div className='wrapper'>
            ...
            <div className="input-wrapper">
                <div>
                    ...
                    />
                    {formik.errors.senderName && formik.touched.senderName && (<p>{formik.errors.senderName}</p>)}
                </div>
                <div>
                ...
                <div>
                    <input id="senderAddress" type='text' placeholder='Адрес' value={formik.values.senderAddress}
                           onChange={formik.handleChange}
                           onBlur={formik.handleBlur}
                    />
        ...
        <div className='wrapper'>
            ...
            <div className="input-wrapper">
                <div>
                    <input id="destinationName" type='text' placeholder='Имя' value={formik.values.destinationName}
                           onChange={formik.handleChange}
                           onBlur={formik.handleBlur}
                    />
                ...
                <div>
                    <input id="destinationTel" type='tel' placeholder='Телефон' value={formik.values.destinationTel}
                           onChange={formik.handleChange}
                           onBlur={formik.handleBlur}
                    />
        ...
        <label> Страхование
            <input id="insurance" type="checkbox" checked={formik.values.insurance} onChange={formik.handleChange}/>
        </label>
